...
def bleu_wrapper(ref_filename, hyp_filename, case_sensitive=False):
  ...
  ref_lines = tf.gfile.Open(ref_filename, "r").read().split("\n")
  hyp_lines = tf.gfile.Open(hyp_filename, "r").read().split("\n")
  ...
  ref_tokens = [x.split() for x in ref_lines]
  hyp_tokens = [x.split() for x in hyp_lines]
